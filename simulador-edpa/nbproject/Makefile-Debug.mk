...
${OBJECTDIR}/estrutura-dados/Heap.o: estrutura-dados/Heap.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estrutura-dados/Heap.o estrutura-dados/Heap.cpp

${OBJECTDIR}/estrutura-dados/Lista.o: estrutura-dados/Lista.cpp 
	${MKDIR} -p ${OBJECTDIR}/estrutura-dados
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estrutura-dados/Lista.o estrutura-dados/Lista.cpp
...
${OBJECTDIR}/tipo/EventoPessoa.o: tipo/EventoPessoa.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/EventoPessoa.o tipo/EventoPessoa.cpp

${OBJECTDIR}/tipo/Pessoa.o: tipo/Pessoa.cpp 
	${MKDIR} -p ${OBJECTDIR}/tipo
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/Pessoa.o tipo/Pessoa.cpp

${OBJECTDIR}/tipo/PessoaFila.o: tipo/PessoaFila.cpp 
	${MKDIR} -p ${OBJECTDIR}/tipo
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/PessoaFila.o tipo/PessoaFila.cpp

${OBJECTDIR}/tipo/Tempo.o: tipo/Tempo.cpp 
	${MKDIR} -p ${OBJECTDIR}/tipo
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/Tempo.o tipo/Tempo.cpp
...
${TESTDIR}/tests/distribuicaoExponencial.o: tests/distribuicaoExponencial.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/distribuicaoExponencial.o tests/distribuicaoExponencial.cpp


${TESTDIR}/tests/TesteEstruturaDados.o: tests/TesteEstruturaDados.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/TesteEstruturaDados.o tests/TesteEstruturaDados.cpp
...
${OBJECTDIR}/estrutura-dados/Heap_nomain.o: ${OBJECTDIR}/estrutura-dados/Heap.o estrutura-dados/Heap.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estrutura-dados/Heap_nomain.o estrutura-dados/Heap.cpp;\
	else  \
...
${OBJECTDIR}/estrutura-dados/Lista_nomain.o: ${OBJECTDIR}/estrutura-dados/Lista.o estrutura-dados/Lista.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/estrutura-dados/Lista_nomain.o estrutura-dados/Lista.cpp;\
	else  \
...
${OBJECTDIR}/simulacao_nomain.o: ${OBJECTDIR}/simulacao.o simulacao.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/simulacao_nomain.o simulacao.cpp;\
	else  \
...
${OBJECTDIR}/tipo/EventoPessoa_nomain.o: ${OBJECTDIR}/tipo/EventoPessoa.o tipo/EventoPessoa.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/EventoPessoa_nomain.o tipo/EventoPessoa.cpp;\
	else  \
...
${OBJECTDIR}/tipo/Pessoa_nomain.o: ${OBJECTDIR}/tipo/Pessoa.o tipo/Pessoa.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/Pessoa_nomain.o tipo/Pessoa.cpp;\
	else  \
...
${OBJECTDIR}/tipo/PessoaFila_nomain.o: ${OBJECTDIR}/tipo/PessoaFila.o tipo/PessoaFila.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/PessoaFila_nomain.o tipo/PessoaFila.cpp;\
	else  \
...
${OBJECTDIR}/tipo/Tempo_nomain.o: ${OBJECTDIR}/tipo/Tempo.o tipo/Tempo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tipo/Tempo_nomain.o tipo/Tempo.cpp;\
	else  \
